...
import { withDemoAuthQueryParam } from '@/utils/demo-auth-url';
...
export function useChat({
	...
	const connectWithRetry = useCallback(
		async (
			...
			try {
				const authenticatedWsUrl = withDemoAuthQueryParam(wsUrl);
				logger.debug('🔗 Attempting WebSocket connection to:', authenticatedWsUrl);
