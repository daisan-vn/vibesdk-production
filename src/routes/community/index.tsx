...
const examples: { title: string; blurb: string }[] = [
  {
    title: "Prompt-to-PIM storefront",
    blurb: "Describe your catalog and let Daisan AI scaffold the product pages.",
  },
  {
    title: "Lead capture landing",
    blurb: "A focused page that turns showroom visits into qualified RFQs.",
  },
  {
    title: "Deployment recipe",
    blurb: "Wire a generated storefront into a one-click deployment flow.",
  },
];
        ...
        >
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-xl text-sm text-text-secondary">
                    Where builders ship commerce experiences with Daisan AI — from
                    PIM-backed storefronts to B2B quote portals and showroom
                    microsites. Some of this is still coming together, and we are
          ...
          <section className="mt-10">
            <div className="flex items-center justify-between gap-4">
              <div>
                <h2 className="text-xl font-semibold text-text-primary">Showcase</h2>
                <p className="mt-1 text-sm text-text-secondary">
                  A taste of what teams are building. These are illustrative
                  examples, not live sites.
                </p>
              </div>
          ...
          <section className="mt-10 grid grid-cols-1 gap-4 lg:grid-cols-2">
            <div className="relative overflow-hidden rounded-2xl border border-border-primary bg-bg-2/40 p-5">
              ...
              <p className="mt-2 text-sm text-text-secondary">
                Swap patterns, share templates and get help shipping commerce
                experiences. We are setting up the channel now — leave the door
                open and we will let you in.
              </p>
            ...
            <div className="rounded-2xl border border-border-primary bg-bg-2/40 p-5">
              ...
              <p className="mt-2 text-sm text-text-secondary">
                For agencies, integrators and solution experts building on the
                Daisan ecosystem. Early partners help shape the templates and
                deployment recipes the community relies on.
              </p>
          ...
          <section className="mt-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold text-text-primary">Examples</h2>
                <p className="mt-1 text-sm text-text-secondary">
